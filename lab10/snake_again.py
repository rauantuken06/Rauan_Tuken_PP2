...
def connect():
    return psycopg2.connect(dbname='lab10', user='postgres', password='Barcelona better than RM', host='localhost', port='5432')
...
if scores: 
    ...
    for score_value, level_value in scores: 
        print(f"Score: {score_value}, Level: {level_value}") 
